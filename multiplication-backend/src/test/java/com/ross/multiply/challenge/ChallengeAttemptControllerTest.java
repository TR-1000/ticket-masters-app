...
public class ChallengeAttemptControllerTest {
	...
	@Test
	 ...
	 long attemptId = 5L;
	 ChallengeAttemptDTO attemptDTO = new ChallengeAttemptDTO("john", 70, 50, 3500);
	 ChallengeAttempt expectedResponse = new ChallengeAttempt(attemptId, user.getUsername(),
	50, 70, 3500, true);
	...
	@Test
	 ...
	 // given an attempt with invalid input data
		ChallengeAttemptDTO attemptDTO = new ChallengeAttemptDTO("john", -70, 2000, 1);
